...
xst -ifn xst.scr
move clk_mult_100mhz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_mult_100mhz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_mult_100mhz_exdes.ucf clk_mult_100mhz_exdes

echo 'Running map'
map -timing -pr b clk_mult_100mhz_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk_mult_100mhz_exdes -w routed.ncd routed.vhd
cd ..
